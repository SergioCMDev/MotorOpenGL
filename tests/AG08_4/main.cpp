...
const char* pathProyecto = "../tests/AG08_4/";
...
void Render(uint32_t VAO, const Shader& shaderCube, const Shader& shaderlight,
	...
	shaderCube.Set("light.cutOff", glm::cos(glm::radians(20.0f)));
	shaderCube.Set("light.outerCutOff", glm::cos(glm::radians(25.0f)));
	...
	shaderCube.Set("light.linear", 0.09f);
	shaderCube.Set("light.cuadratic", 0.032f);
