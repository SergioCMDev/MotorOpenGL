...
void Render(uint32_t VAOQuad, uint32_t VAOQuadFrontal, 
	...
	////Pintamos Cubo 1___ROJO_______________________________________________________________
	...
	mat4 modelCube = glm::mat4(1.0f);
	vec3 posCubes = vec3(0.0f, 0.0f, -3.0f);
	...
	shaderCube.Set("transparencia", 0.1f);
	...
	//Pintamos Cubo 2__________AZUL________________________________________________________
	...
	//////Pintamos Cubo 3_______________VERDE___________________________________________________
	...
	shaderQuad.Set("material.ambient", 1.0f, 0.5f, 0.31f);
	shaderQuad.Set("material.shininess", 52.2f);
	shaderQuad.Set("material.diffuse", 0);
